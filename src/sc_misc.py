...
def calculate_cosine(pred, X):
    ...
    p4Mu = vector.arr({"px": p_l_x, "py": p_l_y, "pz": p_l_z, "E": E}).to_xyzt()
    ...
    p4j1 = vector.arr({"px": p_b_x, "py": p_b_y, "pz": p_b_z, "E": E}).to_xyzt()
    ...
    p4j2 = vector.arr({"px": p_q_x, "py": p_q_y, "pz": p_q_z, "E": E}).to_xyzt()
